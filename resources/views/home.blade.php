...
<section class="homebg text-mainWhite">
  <div class="container py-16 mx-auto space">
    <div class="flex flex-row items-center justify-between gap-2">
      <div class="md:max-w-[50%] max-w-full items-center md:items-start md:text-left text-center flex flex-col gap-16">
        <h1 class="md:w-3/4 w-full text-5xl font-bold">The New PulsarNL Collection is Here!</h1>
        <a href="" class="w-1/2 sm:w-1/3 py-2 text-lg font-bold text-center transition-colors ease-in-out rounded-full bg-mainPurple hover:bg-altPurple">Check it Out</a>
      </div>
      <div class="max-w-[50%] hidden md:block">
  ...
  <div class="container py-12 mx-auto space">
    ...
    <div class="flex flex-col justify-between gap-16 mt-6 lg:flex-row">
      <div class="flex flex-col sm:flex-row w-[47%] justify-between">
        <div class="w-[45%] gap-16 px-8 py-6 bg-white rounded-xl flex justify-between items-center flex-col hover:cursor-pointer hover:scale-105 hover:shadow-lg transition-all ease-in-out">
