        ...
        <div class="flex flex-col flex-wrap p-5 bg-offWhite rounded-2xl basis-64">
          ...
          <div class="flex flex-row justify-between pt-5 mt-auto">
            <div class="flex items-center gap-2" x-data="{ open: false }">
              ...
              @else
                <img src="{{ asset('media/check.svg') }}" class="h-4" alt="">
                <p>--.--</p>
              @endauth
            ...
            <form action="{{ route('addToCart', ['id'=>$product->id]) }}">
              <button class="px-4 py-2 rounded-lg @auth @if ( $product->stock > 0) bg-mainPurple" @else bg-gray-400" disabled @endif @else bg-gray-400" disabled @endguest>
